        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('versioning')
                    ->addDefaultsIfNotSet()
                    ->info('Experimental API versioning (only active when version mutators are declared).')
                    ->children()
                        ->scalarNode('header')
                            ->info('The request header the default version resolver reads.')
                            ->cannotBeEmpty()
                            ->defaultValue('Accept-Version')
                        ->end()
                        ->scalarNode('comparator')
                            ->info('Service id of the version comparator that orders versions (semver by default).')
                            ->cannotBeEmpty()
                            ->defaultValue('api_platform.versioning.comparator.semver')
                        ->end()
                    ->end()
                ->end()
